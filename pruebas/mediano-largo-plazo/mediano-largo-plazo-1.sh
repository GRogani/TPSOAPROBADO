#!/bin/bash
# Prueba Planificación Mediano/Largo Plazo - Algoritmo PMCP
# Actividades:
# - Iniciar los módulos
# - Ejecutar procesos con algoritmo PMCP
# - Esperar la finalización normal

echo "=== Prueba de Planificación de Mediano/Largo Plazo - PMCP ==="
...
# 2. Iniciar KERNEL
echo "Iniciando KERNEL con configuración mediano-largo-plazo-1 (PMCP)..."
cd /home/utnso/Desktop/tp-final-v2/kernel
cp /home/utnso/Desktop/tp-final-v2/config/mediano-largo-plazo/mediano-largo-plazo-1.config kernel.config
...
echo ""
echo "=== Sistema iniciado con algoritmo de Mediano/Largo plazo PMCP ==="
...
echo ""
echo "Prueba de planificación Mediano/Largo plazo PMCP completada."
