...
echo "Script finalizado. Los procesos continúan ejecutándose en segundo plano."
echo "Puedes ver los logs en tiempo real con: tail -f ${BASE_DIR}/memoria-tlb-fifo-[modulo].log"