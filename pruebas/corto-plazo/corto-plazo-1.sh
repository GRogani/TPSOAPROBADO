#!/bin/bash
# Prueba Planificación Corto Plazo - SJF con un CPU
# Actividades:
# - Iniciar los módulos con SJF como algoritmo de corto plazo
# - Ejecutar con una instancia de CPU
# - Levantar IO Disco y esperar a que queden procesos infinitos, luego matar IO Disco

echo "=== Prueba de Planificación de Corto Plazo - SJF ==="
echo "Algoritmo: SJF con un CPU"
...
# 2. Iniciar KERNEL
echo "Iniciando KERNEL con configuración corto-plazo-1 (SJF)..."
cd /home/utnso/Desktop/tp-final-v2/kernel
cp /home/utnso/Desktop/tp-final-v2/config/corto-plazo/corto-plazo-1.config kernel.config
...
echo ""
echo "=== Sistema iniciado con algoritmo SJF y 1 CPU ==="
